...
global $ai_ai_routes, $ai_ai_menu_items;
$ai_ai_routes     = array();
$ai_ai_menu_items = array();

/**
 * Register a route for the ai page.
 *
 ...
 */
function ai_register_ai_route( $path, $content_module = null, $route_module = null ) {
	global $ai_ai_routes;
...
/**
 * Register a menu item for the ai page.
 *
 ...
 */
function ai_register_ai_menu_item( $id, $label, $to, $parent_id = '', $parent_type = '' ) {
	global $ai_ai_menu_items;
	...
	$ai_ai_menu_items[] = $menu_item;
}

/**
 * Get all registered routes for the ai page.
 *
 * @return array Array of route objects.
 */
function ai_get_ai_routes() {
	global $ai_ai_routes;
	return $ai_ai_routes ?? array();
}

/**
 * Get all registered menu items for the ai page.
 *
 * @return array Array of menu item objects.
 */
function ai_get_ai_menu_items() {
	global $ai_ai_menu_items;
	return $ai_ai_menu_items ?? array();
}

/**
 * Preload REST API data for the ai page.
 * Automatically called during page rendering.
 */
function ai_ai_preload_data() {
...
function ai_ai_render_page() {
	...
	/**
	 * Fires when the ai page is initialized so extensions can register routes and menu items.
	 */
	do_action( 'ai_init' );
	...
	if ( file_exists( $asset_file ) ) {
		...
		wp_register_script( 'ai-prerequisites', '', $asset['dependencies'], $asset['version'], true );
		...
		wp_register_style( 'ai-prerequisites', false, $style_dependencies, $asset['version'] );

		// Build dependencies for ai module
		...
		wp_enqueue_script( 'ai-prerequisites' );
		wp_enqueue_script_module( 'ai' );
		wp_enqueue_style( 'ai-prerequisites' );
	}
...
add_action( 'admin_init', 'ai_ai_intercept_render' );
